...
func TestDetectFormat(t *testing.T) {
	tests := []struct {
		...
		{"pptx file", "slides.pptx", FormatPPTX, false},
		{"PPTX uppercase", "SLIDES.PPTX", FormatPPTX, false},
		{"xlsx file", "data.xlsx", FormatXLSX, false},
		{"XLSX uppercase", "DATA.XLSX", FormatXLSX, false},
		{"txt file", "notes.txt", FormatText, false},
		{"Makefile", "Makefile", FormatText, false},
		{"Dockerfile", "Dockerfile", FormatText, false},
		{"LICENSE", "LICENSE", FormatText, false},
		{".gitignore", ".gitignore", FormatText, false},
		{".dockerignore", ".dockerignore", FormatText, false},
		{".editorconfig", ".editorconfig", FormatText, false},
		{".env.example", ".env.example", FormatText, false},
		{".env.local", ".env.local", FormatText, false},
		{".env.production", "path/to/.env.production", FormatText, false},
